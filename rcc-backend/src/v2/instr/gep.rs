...
pub fn lower_gep(
    ...
    debug!(
        "  Base address in {:?}, bank info: {:?}",
        base_addr_reg, base_bank_info
    );
    ...
    if let Some(offset) = static_offset {
        ...
        if offset.abs() >= BANK_SIZE_INSTRUCTIONS as i16 {
            ...
            debug!(
                "  Adjusting: bank_offset={}, addr_offset={}",
            ...
            match result_bank_info {
                ...
                BankInfo::Stack => {
                    if bank_crossing != 0 {
                        ...
                        warn!(
                            "  Stack bank overflow by {} banks - may be invalid!",
                            bank_crossing
                        );
                    }
                }
        ...
        if element_size == 1 {
            ...
            trace!(
                "  Using shift by {} for element size {}",
                shift_amount,
                element_size
            );
        } else {
