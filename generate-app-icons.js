...
async function generateIcons() {
    try {
        ...
        if (largestAppleIcon) {
            ...
            console.log("Created: build-resources/icon.png (will be converted to .icns)");
        }
        ...
        for (const size of sizes) {
            ...
            const icon = response.images.find(img => 
        ...
        console.log("  png2icns build-resources/icon.png -o build-resources/icon.icns");
