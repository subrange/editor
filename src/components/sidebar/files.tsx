...
export function Files() {
  ...
  const saveCurrentFile = () => {
    ...
    const file: SavedFile = {
      ...
      assemblyContent:
        showAssemblyWorkspace && assemblyEditor ? assemblyEditor.getText() : '',
    };
  ...
  const downloadFile = async (file: SavedFile) => {
    ...
    const hasAssemblyContent =
      showAssemblyWorkspace && file.assemblyContent?.trim().length > 0;
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                      <Tooltip
                        content={hasMacros ? 'Download .zip' : 'Download .bf'}
                        side="left"
                      >
                        <button
                          onClick={(e) => {
