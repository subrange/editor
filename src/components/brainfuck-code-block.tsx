...
import { ProgressiveMacroTokenizer, progressiveMacroTokenStyles, type MacroToken } from './editor/services/macro-tokenizer-progressive';
...
export function BrainfuckCodeBlock({ code, className }: BrainfuckCodeBlockProps) {
