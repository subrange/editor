...
} from '../../services/keybindings.service.ts';
...
export function Editor({ store, onFocus, onBlur }: EditorProps) {
  ...
  const extractNavigationItems = useCallback(
    (lines: Line[]): NavigationItem[] => {
    ...
    const resizeObserver = new ResizeObserver((entries) => {
      requestAnimationFrame(() => {
        for (const entry of entries) {
          ...
          getDimensionsStore(store.getId()).updateSize(
            width,
  ...
  function addEditorKeybindings() {
    ...
    keybindingsService.pushKeybindings(keybindingState, [
      keybindingsService.createKeybinding(
        'arrowright',
        'editor.moveright' as AppCommand,
      ),
      keybindingsService.createKeybinding(
        'arrowleft',
        'editor.moveleft' as AppCommand,
      ),
      keybindingsService.createKeybinding(
        'arrowup',
        'editor.moveup' as AppCommand,
      ),
      keybindingsService.createKeybinding(
        'arrowdown',
        'editor.movedown' as AppCommand,
      ),

      keybindingsService.createKeybinding(
        'meta+z',
        'editor.undo' as AppCommand,
      ),
      keybindingsService.createKeybinding(
        'meta+y',
        'editor.redo' as AppCommand,
      ),
      keybindingsService.createKeybinding(
        'meta+shift+z',
        'editor.redo' as AppCommand,
      ...
      keybindingsService.createKeybinding(
        'meta+a',
        'editor.selectall' as AppCommand,
      ),
      keybindingsService.createKeybinding(
        'shift+arrowright',
        'editor.selectright' as AppCommand,
      ),
      keybindingsService.createKeybinding(
        'shift+alt+arrowright',
        'editor.selectwordright' as AppCommand,
      ),
      keybindingsService.createKeybinding(
        'shift+arrowleft',
        'editor.selectleft' as AppCommand,
      ),
      keybindingsService.createKeybinding(
        'shift+alt+arrowleft',
        'editor.selectwordleft' as AppCommand,
      ),
      keybindingsService.createKeybinding(
        'shift+arrowup',
        'editor.selectup' as AppCommand,
      ),
      keybindingsService.createKeybinding(
        'shift+alt+arrowup',
        'editor.selectlineup' as AppCommand,
      ),
      keybindingsService.createKeybinding(
        'shift+arrowdown',
        'editor.selectdown' as AppCommand,
      ),
      keybindingsService.createKeybinding(
        'shift+alt+arrowdown',
        'editor.selectlinedown' as AppCommand,
      ),

      // Line start/end movement
      keybindingsService.createKeybinding(
        'meta+arrowleft',
        'editor.movelinestart' as AppCommand,
      ),
      keybindingsService.createKeybinding(
        'meta+arrowright',
        'editor.movelineend' as AppCommand,
      ),
      keybindingsService.createKeybinding(
        'meta+shift+arrowleft',
        'editor.selectlinestart' as AppCommand,
      ),
      keybindingsService.createKeybinding(
        'meta+shift+arrowright',
        'editor.selectlineend' as AppCommand,
      ),

      // Copy/Cut/Paste
      keybindingsService.createKeybinding(
        'meta+c',
        'editor.copy' as AppCommand,
      ),
      keybindingsService.createKeybinding('meta+x', 'editor.cut' as AppCommand),
      keybindingsService.createKeybinding(
        'meta+v',
        'editor.paste' as AppCommand,
      ),

      // Search
      keybindingsService.createKeybinding(
        'meta+f',
        'editor.search' as AppCommand,
      ),

      // Quick Navigation
      keybindingsService.createKeybinding(
        'meta+p',
        'editor.quicknav' as AppCommand,
      ),

      // Comment/Uncomment
      keybindingsService.createKeybinding(
        'meta+/',
        'editor.togglecomment' as AppCommand,
      ),

      // Cursor position navigation
      keybindingsService.createKeybinding(
        'ctrl+alt+arrowleft',
        'editor.navigateback' as AppCommand,
      ),
      keybindingsService.createKeybinding(
        'ctrl+alt+arrowright',
        'editor.navigateforward' as AppCommand,
      ),
    ]);
