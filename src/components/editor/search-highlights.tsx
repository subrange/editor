...
export function SearchHighlights({ searchStore, charWidth }: SearchHighlightsProps) {
    const matches = useStoreSubscribeToField(searchStore.state, "matches");
    const currentMatchIndex = useStoreSubscribeToField(searchStore.state, "currentMatchIndex");
...
function SearchHighlight({ match, isCurrent, charWidth }: SearchHighlightProps) {
