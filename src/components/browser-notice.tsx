...
export function BrowserNotice() {
    ...
    useEffect(() => {
        ...
        const isChromiumBased = isChrome || isChromium || isEdge || isOpera || isBrave;
            ...
            <div className="px-4 py-3 flex items-center justify-between">
                <div className="flex items-center gap-3">
                    ...
                    <p className="text-sm text-amber-200">
                        <span className="font-semibold">Browser Compatibility Notice:</span> This IDE was not tested in non-Chrome-based browsers.
                        Some features, particularly the code editor, may not work correctly in your current browser. 
                        For the best experience, please use Chrome, Edge, Brave, or another Chromium-based browser.
                    </p>
                </div>
                <button
