        ...
        fetch(filePath)
            ...
            .then(text => {
                ...
                if (titleMatch) {
                    ...
                    } else if (filePath.includes('RIPPLE') || filePath.includes('ASSEMBLY')) {
                            ...
                            <ReactMarkdown
                                ...
                                components={{
                                    ...
                                    h1: ({ children }) => {
                                        ...
                                        return (
                                            <h1 id={id} className="text-3xl font-bold text-zinc-100 mb-6 pb-3 border-b border-zinc-700">
                                                {children}
                                            </h1>
                                        );
                                    },
                                    h2: ({ children }) => {
                                        const id = String(children).toLowerCase().replace(/\s+/g, '-');
                                        return (
                                            <h2 id={id} className="text-2xl font-semibold text-zinc-100 mt-8 mb-4">
                                                {children}
                                            </h2>
                                        );
                                    },
                                    h3: ({ children }) => {
                                        const id = String(children).toLowerCase().replace(/\s+/g, '-');
                                        return (
                                            <h3 id={id} className="text-xl font-semibold text-zinc-200 mt-6 mb-3">
                                                {children}
                                            </h3>
                                        );
                                    },
                                    ...
                                    pre: ({ children }) => {
                                        ...
                                        if (React.isValidElement(children) && children.props) {
                                            ...
                                            if (lang === 'assembly' || lang === 'asm' || 
                                                ...
                                                (!lang && /^\s*(;|\/\/)|^\s*\.(data|code)|^\s*(NOP|ADD|SUB|LOAD|STORE|JAL|BEQ|LI|MOVE)\b/mi.test(codeContent))) {
                                                return (
                                                    <AssemblyCodeBlock 
                                                        code={codeContent}
                                                        className="mb-4"
                                            ...
                                            if (lang === 'brainfuck' || lang === 'bf' || 
                                                ...
                                                (!lang && /^[#@{]|#define|@\w+|\{(repeat|if|for|reverse|preserve)/.test(codeContent))) {
                                                return (
                                                    <BrainfuckCodeBlock 
                                                        code={codeContent}
                                                        className="mb-4"
                                    ...
                                    a: ({ href, children }) => {
                                        ...
                                        if (isAnchorLink) {
                                            ...
                                            const handleClick = (e: React.MouseEvent) => {
                                                ...
                                                const elementId = targetId.toLowerCase().replace(/\s+/g, '-');
