...
#define PROGRAM {
  ...
  @prg(
    ...
    @cmd(@OP_STOR  , @R3 , @R13, 8)
    @cmd(@OP_ADDI  , @R5 , @R15, 2)
    @cmd(@OP_LI    , @R3 , 10  , 0)
    @cmd(@OP_ADDI  , @R6 , @R15, 2)
    @cmd(@OP_STOR  , @R3 , @R13, 8)
    @cmd(@OP_ADDI  , @R5 , @R15, 3)
    @cmd(@OP_ADDI  , @R7 , @R15, 1)
    @cmd(@OP_LOAD  , @R6 , @R13, @R7)
    @cmd(@OP_ADDI  , @R9 , @R15, 2)
    @cmd(@OP_LOAD  , @R8 , @R13, @R9)
    @cmd(@OP_ADD   , @R3 , @R6 , @R0)
    @cmd(@OP_ADD   , @R4 , @R8 , @R0)
    @cmd(@OP_JAL   , 3   , 0   , 0)
    @cmd(@OP_ADD   , @R10, @R3 , @R0)
    @cmd(@OP_ADDI  , @R5 , @R15, 3)
    @cmd(@OP_STOR  , @R10, @R13, 7)
    @cmd(@OP_ADDI  , @R6 , @R15, 3)
    @cmd(@OP_LOAD  , @R5 , @R13, @R6)
    @cmd(@OP_LI    , @R4 , 15  , 0)
    @cmd(@OP_SLTU  , @R8 , @R5 , @R4)
    @cmd(@OP_SLTU  , @R9 , @R4 , @R5)
    @cmd(@OP_OR    , @R7 , @R8 , @R9)
    @cmd(@OP_LI    , @R9 , 1   , 0)
    @cmd(@OP_SUB   , @R7 , @R9 , @R7)
    @cmd(@OP_BNE   , @R7 , @R0 , 2)
