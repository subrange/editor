...
; Bank value in S2 - tags: -1 = Global, -2 = Stack, positive = dynamic
    LI S1, -1
    BEQ S2, S1, L_bc_1bb5854c_use_global
    LI T6, -2
    BEQ S2, T6, L_bc_1bb5854c_use_stack
    ADD T7, S2, R0
    BEQ R0, R0, L_bc_1bb5854c_done
L_bc_1bb5854c_use_global:
    ADD T7, GP, R0
    BEQ R0, R0, L_bc_1bb5854c_done
L_bc_1bb5854c_use_stack:
    ADD T7, SB, R0
L_bc_1bb5854c_done:
    MOVE RV0, T0
    MOVE RV1, T7
...
; GEP: Setting bank info for t33 to Dynamic("gep_new_bank_f8_op58_t33")
    LI S2, 0
    LI S1, -1
    BEQ T3, S1, L_bc_981d9cfc_use_global
    LI T4, -2
    BEQ T3, T4, L_bc_981d9cfc_use_stack
    ADD RV0, T3, R0
    BEQ R0, R0, L_bc_981d9cfc_done
L_bc_981d9cfc_use_global:
    ADD RV0, GP, R0
    BEQ R0, R0, L_bc_981d9cfc_done
L_bc_981d9cfc_use_stack:
    ADD RV0, SB, R0
L_bc_981d9cfc_done:
    STORE S2, RV0, S3
...
; Spill t26 to slot 10
    ...
    STORE T6, SB, SC
    LI T6, -1
    BEQ T7, T6, L_bc_72f3408c_use_global
...
; Spill load_f8_op51_t31_bank_val to slot 12
    ...
    STORE T1, SB, SC
    LI T5, -2
    BEQ T7, T5, L_bc_72f3408c_use_stack
    ADD S1, T7, R0
    BEQ R0, R0, L_bc_72f3408c_done
L_bc_72f3408c_use_global:
    ADD S1, GP, R0
    BEQ R0, R0, L_bc_72f3408c_done
L_bc_72f3408c_use_stack:
    ADD S1, SB, R0
L_bc_72f3408c_done:
    MOVE RV0, T2
    MOVE RV1, S1
