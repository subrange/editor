...
; LOAD: Pointer t10 has bank info: Dynamic("gep_new_bank_f0_op33_t10")
    LI T2, -1
    BEQ S3, T2, L_bc_2046dfe5_use_global
    LI T6, -2
    BEQ S3, T6, L_bc_2046dfe5_use_stack
    ADD T3, S3, R0
    BEQ R0, R0, L_bc_2046dfe5_done
L_bc_2046dfe5_use_global:
    ADD T3, GP, R0
    BEQ R0, R0, L_bc_2046dfe5_done
L_bc_2046dfe5_use_stack:
    ADD T3, SB, R0
L_bc_2046dfe5_done:
...
; Reload gep_new_bank_f0_op22_t7 from slot 6
    ...
    LOAD T2, SB, SC
    LI T5, -1
    BEQ T2, T5, L_bc_abe7a211_use_global
    LI S0, -2
    BEQ T2, S0, L_bc_abe7a211_use_stack
    ADD T6, T2, R0
    BEQ R0, R0, L_bc_abe7a211_done
L_bc_abe7a211_use_global:
    ADD T6, GP, R0
    BEQ R0, R0, L_bc_abe7a211_done
L_bc_abe7a211_use_stack:
    ADD T6, SB, R0
L_bc_abe7a211_done:
    STORE T0, T6, T4
...
; LOAD: Pointer t14 has bank info: Dynamic("gep_new_bank_f0_op52_t14")
    LI T3, -1
    BEQ T2, T3, L_bc_1803178a_use_global
    LI T0, -2
    BEQ T2, T0, L_bc_1803178a_use_stack
    ADD S3, T2, R0
    BEQ R0, R0, L_bc_1803178a_done
L_bc_1803178a_use_global:
    ADD S3, GP, R0
    BEQ R0, R0, L_bc_1803178a_done
L_bc_1803178a_use_stack:
    ADD S3, SB, R0
L_bc_1803178a_done:
...
; Spill load_f0_op45_t12_bank_val to slot 20
    ...
    STORE S1, SB, SC
    LI S0, -1
    BEQ T0, S0, L_bc_ad1bc7c9_use_global
; Spill t13 to slot 21
    ADD SC, FP, R0
    ADDI SC, SC, 34
    STORE T1, SB, SC
    LI T1, -2
    BEQ T0, T1, L_bc_ad1bc7c9_use_stack
    ADD T5, T0, R0
    BEQ R0, R0, L_bc_ad1bc7c9_done
L_bc_ad1bc7c9_use_global:
    ADD T5, GP, R0
    BEQ R0, R0, L_bc_ad1bc7c9_done
L_bc_ad1bc7c9_use_stack:
    ADD T5, SB, R0
L_bc_ad1bc7c9_done:
    MOVE RV0, T3
    MOVE RV1, T5
...
; LOAD: Pointer t12 has bank info: Dynamic("gep_new_bank_f2_op28_t12")
    LI T7, -1
    BEQ S2, T7, L_bc_0c5a9f3f_use_global
    LI T4, -2
    BEQ S2, T4, L_bc_0c5a9f3f_use_stack
    ADD T1, S2, R0
    BEQ R0, R0, L_bc_0c5a9f3f_done
L_bc_0c5a9f3f_use_global:
    ADD T1, GP, R0
    BEQ R0, R0, L_bc_0c5a9f3f_done
L_bc_0c5a9f3f_use_stack:
    ADD T1, SB, R0
L_bc_0c5a9f3f_done:
...
; LOAD: Pointer t19 has bank info: Dynamic("gep_new_bank_f2_op54_t19")
    LI T4, -1
    BEQ S2, T4, L_bc_41b94b93_use_global
    LI S3, -2
    BEQ S2, S3, L_bc_41b94b93_use_stack
    ADD T7, S2, R0
    BEQ R0, R0, L_bc_41b94b93_done
L_bc_41b94b93_use_global:
    ADD T7, GP, R0
    BEQ R0, R0, L_bc_41b94b93_done
L_bc_41b94b93_use_stack:
    ADD T7, SB, R0
L_bc_41b94b93_done:
...
; Reload gep_new_bank_f2_op43_t16 from slot 15
    ...
    LOAD T4, SB, SC
    LI T3, -1
    BEQ T4, T3, L_bc_bd572e91_use_global
    LI S0, -2
    BEQ T4, S0, L_bc_bd572e91_use_stack
    ADD S3, T4, R0
    BEQ R0, R0, L_bc_bd572e91_done
L_bc_bd572e91_use_global:
    ADD S3, GP, R0
    BEQ R0, R0, L_bc_bd572e91_done
L_bc_bd572e91_use_stack:
    ADD S3, SB, R0
L_bc_bd572e91_done:
    STORE T2, S3, S1
...
; GEP: Setting bank info for t26 to Dynamic("gep_new_bank_f2_op77_t26")
    LI S2, 0
    LI T2, -1
    BEQ T4, T2, L_bc_b16337a1_use_global
    LI S1, -2
    BEQ T4, S1, L_bc_b16337a1_use_stack
    ADD T7, T4, R0
    BEQ R0, R0, L_bc_b16337a1_done
L_bc_b16337a1_use_global:
    ADD T7, GP, R0
    BEQ R0, R0, L_bc_b16337a1_done
L_bc_b16337a1_use_stack:
    ADD T7, SB, R0
L_bc_b16337a1_done:
    STORE S2, T7, T1
...
; Spill load_f2_op70_t24_bank_val to slot 31
    ...
    STORE T5, SB, SC
    LI T5, -1
    BEQ T0, T5, L_bc_5431fb18_use_global
...
; Spill gep_new_bank_f2_op77_t26 to slot 33
    ...
    STORE T4, SB, SC
    LI T1, -2
    BEQ T0, T1, L_bc_5431fb18_use_stack
    ADD S0, T0, R0
    BEQ R0, R0, L_bc_5431fb18_done
L_bc_5431fb18_use_global:
    ADD S0, GP, R0
    BEQ R0, R0, L_bc_5431fb18_done
L_bc_5431fb18_use_stack:
    ADD S0, SB, R0
L_bc_5431fb18_done:
    MOVE RV0, S2
    MOVE RV1, S0
...
; LOAD: Pointer t5 has bank info: Dynamic("gep_new_bank_f4_op17_t5")
    LI T7, -1
    BEQ T4, T7, L_bc_e2d4ca50_use_global
    LI S0, -2
    BEQ T4, S0, L_bc_e2d4ca50_use_stack
    ADD S1, T4, R0
    BEQ R0, R0, L_bc_e2d4ca50_done
L_bc_e2d4ca50_use_global:
    ADD S1, GP, R0
    BEQ R0, R0, L_bc_e2d4ca50_done
L_bc_e2d4ca50_use_stack:
    ADD S1, SB, R0
L_bc_e2d4ca50_done:
...
; LOAD: Pointer t7 has bank info: Dynamic("gep_new_bank_f6_op22_t7")
    LI T7, -1
    BEQ S3, T7, L_bc_f3d021ce_use_global
    LI S1, -2
    BEQ S3, S1, L_bc_f3d021ce_use_stack
    ADD T5, S3, R0
    BEQ R0, R0, L_bc_f3d021ce_done
L_bc_f3d021ce_use_global:
    ADD T5, GP, R0
    BEQ R0, R0, L_bc_f3d021ce_done
L_bc_f3d021ce_use_stack:
    ADD T5, SB, R0
L_bc_f3d021ce_done:
...
; LOAD: Pointer t12 has bank info: Dynamic("gep_new_bank_f6_op39_t12")
    LI T0, -1
    BEQ T5, T0, L_bc_36f75f70_use_global
    LI T4, -2
    BEQ T5, T4, L_bc_36f75f70_use_stack
    ADD T6, T5, R0
    BEQ R0, R0, L_bc_36f75f70_done
L_bc_36f75f70_use_global:
    ADD T6, GP, R0
    BEQ R0, R0, L_bc_36f75f70_done
L_bc_36f75f70_use_stack:
    ADD T6, SB, R0
L_bc_36f75f70_done:
...
; LOAD: Pointer t18 has bank info: Dynamic("gep_new_bank_f6_op56_t18")
    LI T7, -1
    BEQ T5, T7, L_bc_93ff50d7_use_global
    LI T3, -2
    BEQ T5, T3, L_bc_93ff50d7_use_stack
    ADD S2, T5, R0
    BEQ R0, R0, L_bc_93ff50d7_done
L_bc_93ff50d7_use_global:
    ADD S2, GP, R0
    BEQ R0, R0, L_bc_93ff50d7_done
L_bc_93ff50d7_use_stack:
    ADD S2, SB, R0
L_bc_93ff50d7_done:
...
; LOAD: Pointer t22 has bank info: Dynamic("gep_new_bank_f6_op71_t22")
    LI T4, -1
    BEQ S2, T4, L_bc_93cc266b_use_global
    LI S3, -2
    BEQ S2, S3, L_bc_93cc266b_use_stack
    ADD S1, S2, R0
    BEQ R0, R0, L_bc_93cc266b_done
L_bc_93cc266b_use_global:
    ADD S1, GP, R0
    BEQ R0, R0, L_bc_93cc266b_done
L_bc_93cc266b_use_stack:
    ADD S1, SB, R0
L_bc_93cc266b_done:
; LOAD: Using bank register S1 for load
    LOAD T5, S1, T0
...
; LOAD: Pointer t27 has bank info: Dynamic("gep_new_bank_f6_op88_t27")
    LI T6, -1
    BEQ S2, T6, L_bc_becdb162_use_global
    LI T1, -2
    BEQ S2, T1, L_bc_becdb162_use_stack
    ADD T3, S2, R0
    BEQ R0, R0, L_bc_becdb162_done
L_bc_becdb162_use_global:
    ADD T3, GP, R0
    BEQ R0, R0, L_bc_becdb162_done
L_bc_becdb162_use_stack:
    ADD T3, SB, R0
L_bc_becdb162_done:
; LOAD: Using bank register T3 for load
    LOAD T0, T3, T5
...
; LOAD: Pointer t31 has bank info: Dynamic("gep_new_bank_f6_op103_t31")
    LI T2, -1
    BEQ T3, T2, L_bc_96df9fe2_use_global
    LI T5, -2
    BEQ T3, T5, L_bc_96df9fe2_use_stack
    ADD S0, T3, R0
    BEQ R0, R0, L_bc_96df9fe2_done
L_bc_96df9fe2_use_global:
    ADD S0, GP, R0
    BEQ R0, R0, L_bc_96df9fe2_done
L_bc_96df9fe2_use_stack:
    ADD S0, SB, R0
L_bc_96df9fe2_done:
...
; LOAD: Pointer t40 has bank info: Dynamic("gep_new_bank_f6_op123_t40")
    LI T3, -1
    BEQ T5, T3, L_bc_ebf2f783_use_global
    LI S0, -2
    BEQ T5, S0, L_bc_ebf2f783_use_stack
    ADD S3, T5, R0
    BEQ R0, R0, L_bc_ebf2f783_done
L_bc_ebf2f783_use_global:
    ADD S3, GP, R0
    BEQ R0, R0, L_bc_ebf2f783_done
L_bc_ebf2f783_use_stack:
    ADD S3, SB, R0
L_bc_ebf2f783_done:
; LOAD: Using bank register S3 for load
    LOAD T0, S3, T4
...
; LOAD: Pointer t44 has bank info: Dynamic("gep_new_bank_f6_op138_t44")
    LI T1, -1
    BEQ S3, T1, L_bc_452f41d6_use_global
    LI T4, -2
    BEQ S3, T4, L_bc_452f41d6_use_stack
    ADD S1, S3, R0
    BEQ R0, R0, L_bc_452f41d6_done
L_bc_452f41d6_use_global:
    ADD S1, GP, R0
    BEQ R0, R0, L_bc_452f41d6_done
L_bc_452f41d6_use_stack:
    ADD S1, SB, R0
L_bc_452f41d6_done:
; LOAD: Using bank register S1 for load
    LOAD T5, S1, T7
...
; LOAD: Pointer t12 has bank info: Dynamic("gep_new_bank_f8_op28_t12")
    LI T7, -1
    BEQ S2, T7, L_bc_cc15304d_use_global
    LI T4, -2
    BEQ S2, T4, L_bc_cc15304d_use_stack
    ADD T1, S2, R0
    BEQ R0, R0, L_bc_cc15304d_done
L_bc_cc15304d_use_global:
    ADD T1, GP, R0
    BEQ R0, R0, L_bc_cc15304d_done
L_bc_cc15304d_use_stack:
    ADD T1, SB, R0
L_bc_cc15304d_done:
; LOAD: Using bank register T1 for load
    LOAD S3, T1, T0
...
; LOAD: Pointer t17 has bank info: Dynamic("gep_new_bank_f8_op45_t17")
    LI T6, -1
    BEQ T1, T6, L_bc_d7e30426_use_global
    LI T0, -2
    BEQ T1, T0, L_bc_d7e30426_use_stack
    ADD T5, T1, R0
    BEQ R0, R0, L_bc_d7e30426_done
L_bc_d7e30426_use_global:
    ADD T5, GP, R0
    BEQ R0, R0, L_bc_d7e30426_done
L_bc_d7e30426_use_stack:
    ADD T5, SB, R0
L_bc_d7e30426_done:
; LOAD: Using bank register T5 for load
    LOAD S2, T5, T3
...
; LOAD: Pointer t23 has bank info: Dynamic("gep_new_bank_f8_op62_t23")
    LI T7, -1
    BEQ T1, T7, L_bc_1134e9d5_use_global
    LI T2, -2
    BEQ T1, T2, L_bc_1134e9d5_use_stack
    ADD S1, T1, R0
    BEQ R0, R0, L_bc_1134e9d5_done
L_bc_1134e9d5_use_global:
    ADD S1, GP, R0
    BEQ R0, R0, L_bc_1134e9d5_done
L_bc_1134e9d5_use_stack:
    ADD S1, SB, R0
L_bc_1134e9d5_done:
; LOAD: Using bank register S1 for load
    LOAD T3, S1, S2
...
; LOAD: Pointer t27 has bank info: Dynamic("gep_new_bank_f8_op77_t27")
    LI T0, -1
    BEQ S1, T0, L_bc_12ae411f_use_global
    LI S2, -2
    BEQ S1, S2, L_bc_12ae411f_use_stack
    ADD S0, S1, R0
    BEQ R0, R0, L_bc_12ae411f_done
L_bc_12ae411f_use_global:
    ADD S0, GP, R0
    BEQ R0, R0, L_bc_12ae411f_done
L_bc_12ae411f_use_stack:
    ADD S0, SB, R0
L_bc_12ae411f_done:
; LOAD: Using bank register S0 for load
    LOAD T1, S0, T6
...
; LOAD: Pointer t32 has bank info: Dynamic("gep_new_bank_f8_op92_t32")
    LI S3, -1
    BEQ S0, S3, L_bc_93320174_use_global
    LI T6, -2
    BEQ S0, T6, L_bc_93320174_use_stack
    ADD T5, S0, R0
    BEQ R0, R0, L_bc_93320174_done
L_bc_93320174_use_global:
    ADD T5, GP, R0
    BEQ R0, R0, L_bc_93320174_done
L_bc_93320174_use_stack:
    ADD T5, SB, R0
L_bc_93320174_done:
; LOAD: Using bank register T5 for load
    LOAD S1, T5, T2
...
; LOAD: Pointer t36 has bank info: Dynamic("gep_new_bank_f8_op107_t36")
    LI T4, -1
    BEQ T5, T4, L_bc_4e7a6173_use_global
    LI T2, -2
    BEQ T5, T2, L_bc_4e7a6173_use_stack
    ADD T1, T5, R0
    BEQ R0, R0, L_bc_4e7a6173_done
L_bc_4e7a6173_use_global:
    ADD T1, GP, R0
    BEQ R0, R0, L_bc_4e7a6173_done
L_bc_4e7a6173_use_stack:
    ADD T1, SB, R0
L_bc_4e7a6173_done:
; LOAD: Using bank register T1 for load
    LOAD S0, T1, S2
...
; LOAD: Pointer t41 has bank info: Dynamic("gep_new_bank_f8_op124_t41")
    LI T3, -1
    BEQ T5, T3, L_bc_75ce6e13_use_global
    LI T0, -2
    BEQ T5, T0, L_bc_75ce6e13_use_stack
    ADD T6, T5, R0
    BEQ R0, R0, L_bc_75ce6e13_done
L_bc_75ce6e13_use_global:
    ADD T6, GP, R0
    BEQ R0, R0, L_bc_75ce6e13_done
L_bc_75ce6e13_use_stack:
    ADD T6, SB, R0
L_bc_75ce6e13_done:
; LOAD: Using bank register T6 for load
    LOAD S2, T6, S0
...
; LOAD: Pointer t45 has bank info: Dynamic("gep_new_bank_f8_op139_t45")
    LI S1, -1
    BEQ T6, S1, L_bc_122fd6aa_use_global
    LI S0, -2
    BEQ T6, S0, L_bc_122fd6aa_use_stack
    ADD S3, T6, R0
    BEQ R0, R0, L_bc_122fd6aa_done
L_bc_122fd6aa_use_global:
    ADD S3, GP, R0
    BEQ R0, R0, L_bc_122fd6aa_done
L_bc_122fd6aa_use_stack:
    ADD S3, SB, R0
L_bc_122fd6aa_done:
; LOAD: Using bank register S3 for load
    LOAD T5, S3, T2
...
; LOAD: Pointer t15 has bank info: Dynamic("gep_new_bank_f10_op40_t15")
    LI T7, -1
    BEQ S2, T7, L_bc_8e923681_use_global
    LI T3, -2
    BEQ S2, T3, L_bc_8e923681_use_stack
    ADD T6, S2, R0
    BEQ R0, R0, L_bc_8e923681_done
L_bc_8e923681_use_global:
    ADD T6, GP, R0
    BEQ R0, R0, L_bc_8e923681_done
L_bc_8e923681_use_stack:
    ADD T6, SB, R0
L_bc_8e923681_done:
; LOAD: Using bank register T6 for load
    LOAD T5, T6, RV0
    LI T3, -1
    BEQ T4, T3, L_bc_d1d58ff7_use_global
    LI S0, -2
    BEQ T4, S0, L_bc_d1d58ff7_use_stack
    ADD T7, T4, R0
    BEQ R0, R0, L_bc_d1d58ff7_done
L_bc_d1d58ff7_use_global:
    ADD T7, GP, R0
    BEQ R0, R0, L_bc_d1d58ff7_done
L_bc_d1d58ff7_use_stack:
    ADD T7, SB, R0
L_bc_d1d58ff7_done:
    STORE T5, T7, T2
...
; LOAD: Pointer t19 has bank info: Dynamic("gep_new_bank_f10_op59_t19")
    LI S2, -1
    BEQ T2, S2, L_bc_25462b4a_use_global
    LI T6, -2
    BEQ T2, T6, L_bc_25462b4a_use_stack
    ADD RV0, T2, R0
    BEQ R0, R0, L_bc_25462b4a_done
L_bc_25462b4a_use_global:
    ADD RV0, GP, R0
    BEQ R0, R0, L_bc_25462b4a_done
L_bc_25462b4a_use_stack:
    ADD RV0, SB, R0
L_bc_25462b4a_done:
...
; Spill store_f10_op45_resolved_bank_10_f10_op46 to slot 22
    ...
    STORE T7, SB, SC
    LI T7, -1
    BEQ T6, T7, L_bc_f8b48997_use_global
...
; Spill load_f10_op52_t17_bank_val to slot 24
    ...
    STORE T0, SB, SC
    LI S0, -2
    BEQ T6, S0, L_bc_f8b48997_use_stack
    ADD T3, T6, R0
    BEQ R0, R0, L_bc_f8b48997_done
L_bc_f8b48997_use_global:
    ADD T3, GP, R0
    BEQ R0, R0, L_bc_f8b48997_done
L_bc_f8b48997_use_stack:
    ADD T3, SB, R0
L_bc_f8b48997_done:
    MOVE RV0, S2
    MOVE RV1, T3
...
; LOAD: Pointer t15 has bank info: Dynamic("gep_new_bank_f12_op33_t15")
    LI T7, -1
    BEQ S3, T7, L_bc_57b39071_use_global
    LI S1, -2
    BEQ S3, S1, L_bc_57b39071_use_stack
    ADD S0, S3, R0
    BEQ R0, R0, L_bc_57b39071_done
L_bc_57b39071_use_global:
    ADD S0, GP, R0
    BEQ R0, R0, L_bc_57b39071_done
L_bc_57b39071_use_stack:
    ADD S0, SB, R0
L_bc_57b39071_done:
; LOAD: Using bank register S0 for load
    LOAD S2, S0, T5
...
; LOAD: Pointer t25 has bank info: Dynamic("gep_new_bank_f12_op63_t25")
    LI T0, -1
    BEQ S2, T0, L_bc_e5cf6575_use_global
    LI S1, -2
    BEQ S2, S1, L_bc_e5cf6575_use_stack
    ADD T7, S2, R0
    BEQ R0, R0, L_bc_e5cf6575_done
L_bc_e5cf6575_use_global:
    ADD T7, GP, R0
    BEQ R0, R0, L_bc_e5cf6575_done
L_bc_e5cf6575_use_stack:
    ADD T7, SB, R0
L_bc_e5cf6575_done:
; LOAD: Using bank register T7 for load
    LOAD T4, T7, S0
    LI S1, -1
    BEQ S3, S1, L_bc_d57a36e3_use_global
    LI T3, -2
    BEQ S3, T3, L_bc_d57a36e3_use_stack
    ADD T0, S3, R0
    BEQ R0, R0, L_bc_d57a36e3_done
L_bc_d57a36e3_use_global:
    ADD T0, GP, R0
    BEQ R0, R0, L_bc_d57a36e3_done
L_bc_d57a36e3_use_stack:
    ADD T0, SB, R0
L_bc_d57a36e3_done:
    STORE T4, T0, RV0
...
; GEP: Setting bank info for t35 to Dynamic("gep_new_bank_f12_op89_t35")
    LI T4, 0
    LI S3, -1
    BEQ T3, S3, L_bc_39fe29e7_use_global
    LI T0, -2
    BEQ T3, T0, L_bc_39fe29e7_use_stack
    ADD RV0, T3, R0
    BEQ R0, R0, L_bc_39fe29e7_done
L_bc_39fe29e7_use_global:
    ADD RV0, GP, R0
    BEQ R0, R0, L_bc_39fe29e7_done
L_bc_39fe29e7_use_stack:
    ADD RV0, SB, R0
L_bc_39fe29e7_done:
    STORE T4, RV0, T7
...
; Spill t30 to slot 33
    ...
    STORE T6, SB, SC
    LI T6, -1
    BEQ T4, T6, L_bc_52f49108_use_global
    LI T2, -2
    BEQ T4, T2, L_bc_52f49108_use_stack
    ADD T0, T4, R0
    BEQ R0, R0, L_bc_52f49108_done
L_bc_52f49108_use_global:
    ADD T0, GP, R0
    BEQ R0, R0, L_bc_52f49108_done
L_bc_52f49108_use_stack:
    ADD T0, SB, R0
L_bc_52f49108_done:
    MOVE RV0, S3
    MOVE RV1, T0
...
; LOAD: Pointer t7 has bank info: Dynamic("gep_new_bank_f14_op19_t7")
    LI T7, -1
    BEQ S3, T7, L_bc_6725caaa_use_global
    LI S1, -2
    BEQ S3, S1, L_bc_6725caaa_use_stack
    ADD T6, S3, R0
    BEQ R0, R0, L_bc_6725caaa_done
L_bc_6725caaa_use_global:
    ADD T6, GP, R0
    BEQ R0, R0, L_bc_6725caaa_done
L_bc_6725caaa_use_stack:
    ADD T6, SB, R0
L_bc_6725caaa_done:
; LOAD: Using bank register T6 for load
    LOAD T2, T6, T5
...
; LOAD: Pointer t11 has bank info: Dynamic("gep_new_bank_f14_op34_t11")
    LI S0, -1
    BEQ S3, S0, L_bc_8d6f470f_use_global
    LI T1, -2
    BEQ S3, T1, L_bc_8d6f470f_use_stack
    ADD T3, S3, R0
    BEQ R0, R0, L_bc_8d6f470f_done
L_bc_8d6f470f_use_global:
    ADD T3, GP, R0
    BEQ R0, R0, L_bc_8d6f470f_done
L_bc_8d6f470f_use_stack:
    ADD T3, SB, R0
L_bc_8d6f470f_done:
; LOAD: Using bank register T3 for load
    LOAD T5, T3, S2
...
; GEP: Setting bank info for t17 to Dynamic("gep_new_bank_f14_op53_t17")
    LI T2, -1
    BEQ S3, T2, L_bc_f54f5ab5_use_global
    LI T0, -2
    BEQ S3, T0, L_bc_f54f5ab5_use_stack
    ADD S1, S3, R0
    BEQ R0, R0, L_bc_f54f5ab5_done
L_bc_f54f5ab5_use_global:
    ADD S1, GP, R0
    BEQ R0, R0, L_bc_f54f5ab5_done
L_bc_f54f5ab5_use_stack:
    ADD S1, SB, R0
L_bc_f54f5ab5_done:
    MOVE RV0, T1
    MOVE RV1, S1
...
; GEP: Setting bank info for t26 to Dynamic("gep_new_bank_f14_op76_t26")
    LI T1, -1
    BEQ T2, T1, L_bc_ff1a05ae_use_global
    LI S3, -2
    BEQ T2, S3, L_bc_ff1a05ae_use_stack
    ADD T5, T2, R0
    BEQ R0, R0, L_bc_ff1a05ae_done
L_bc_ff1a05ae_use_global:
    ADD T5, GP, R0
    BEQ R0, R0, L_bc_ff1a05ae_done
L_bc_ff1a05ae_use_stack:
    ADD T5, SB, R0
L_bc_ff1a05ae_done:
    MOVE RV0, S0
    MOVE RV1, T5
...
; LOAD: Pointer t8 has bank info: Dynamic("gep_new_bank_f16_op21_t8")
    LI T7, -1
    BEQ S3, T7, L_bc_9433bc97_use_global
    LI S1, -2
    BEQ S3, S1, L_bc_9433bc97_use_stack
    ADD T6, S3, R0
    BEQ R0, R0, L_bc_9433bc97_done
L_bc_9433bc97_use_global:
    ADD T6, GP, R0
    BEQ R0, R0, L_bc_9433bc97_done
L_bc_9433bc97_use_stack:
    ADD T6, SB, R0
L_bc_9433bc97_done:
; LOAD: Using bank register T6 for load
    LOAD T0, T6, T4
...
; LOAD: Pointer t12 has bank info: Dynamic("gep_new_bank_f16_op36_t12")
    LI T3, -1
    BEQ S3, T3, L_bc_ba367927_use_global
    LI S0, -2
    BEQ S3, S0, L_bc_ba367927_use_stack
    ADD T1, S3, R0
    BEQ R0, R0, L_bc_ba367927_done
L_bc_ba367927_use_global:
    ADD T1, GP, R0
    BEQ R0, R0, L_bc_ba367927_done
L_bc_ba367927_use_stack:
    ADD T1, SB, R0
L_bc_ba367927_done:
; LOAD: Using bank register T1 for load
    LOAD T4, T1, S2
...
; GEP: Setting bank info for t27 to Dynamic("gep_new_bank_f16_op77_t27")
    LI T4, -1
    BEQ S2, T4, L_bc_7cd4c167_use_global
    LI S0, -2
    BEQ S2, S0, L_bc_7cd4c167_use_stack
    ADD T5, S2, R0
    BEQ R0, R0, L_bc_7cd4c167_done
L_bc_7cd4c167_use_global:
    ADD T5, GP, R0
    BEQ R0, R0, L_bc_7cd4c167_done
L_bc_7cd4c167_use_stack:
    ADD T5, SB, R0
L_bc_7cd4c167_done:
    MOVE RV0, T7
    MOVE RV1, T5
...
; Bank value in T2 - tags: -1 = Global, -2 = Stack, positive = dynamic
    LI S0, -1
    BEQ T2, S0, L_bc_f75cb1f1_use_global
; Spill t22 to slot 26
    ADD SC, FP, R0
    ADDI SC, SC, 40
    STORE T3, SB, SC
    LI T3, -2
    BEQ T2, T3, L_bc_f75cb1f1_use_stack
    ADD S1, T2, R0
    BEQ R0, R0, L_bc_f75cb1f1_done
L_bc_f75cb1f1_use_global:
    ADD S1, GP, R0
    BEQ R0, R0, L_bc_f75cb1f1_done
L_bc_f75cb1f1_use_stack:
    ADD S1, SB, R0
L_bc_f75cb1f1_done:
    MOVE RV0, T4
    MOVE RV1, S1
...
; LOAD: Pointer t19 has bank info: Dynamic("gep_new_bank_f18_op51_t19")
    LI T7, -1
    BEQ T1, T7, L_bc_8e17c0a7_use_global
    LI T4, -2
    BEQ T1, T4, L_bc_8e17c0a7_use_stack
    ADD T6, T1, R0
    BEQ R0, R0, L_bc_8e17c0a7_done
L_bc_8e17c0a7_use_global:
    ADD T6, GP, R0
    BEQ R0, R0, L_bc_8e17c0a7_done
L_bc_8e17c0a7_use_stack:
    ADD T6, SB, R0
L_bc_8e17c0a7_done:
; LOAD: Using bank register T6 for load
    LOAD T5, T6, S3
; Reload gep_new_bank_f18_op40_t16 from slot 13
    ...
    LOAD T7, SB, SC
    LI S0, -1
    BEQ T7, S0, L_bc_75786d65_use_global
    LI T3, -2
    BEQ T7, T3, L_bc_75786d65_use_stack
    ADD T4, T7, R0
    BEQ R0, R0, L_bc_75786d65_done
L_bc_75786d65_use_global:
    ADD T4, GP, R0
    BEQ R0, R0, L_bc_75786d65_done
L_bc_75786d65_use_stack:
    ADD T4, SB, R0
L_bc_75786d65_done:
    STORE T5, T4, S2
...
; Spill gep_new_bank_f18_op51_t19 to slot 20
    ...
    STORE T1, SB, SC
    LI T1, -1
    BEQ S3, T1, L_bc_34a1cfc3_use_global
; Spill load_f18_op52_t20_resolved_bank_18_f18_op53 to slot 21
    ADD SC, FP, R0
    ADDI SC, SC, 39
    STORE T6, SB, SC
    LI T6, -2
    BEQ S3, T6, L_bc_34a1cfc3_use_stack
    ADD T0, S3, R0
    BEQ R0, R0, L_bc_34a1cfc3_done
L_bc_34a1cfc3_use_global:
    ADD T0, GP, R0
    BEQ R0, R0, L_bc_34a1cfc3_done
L_bc_34a1cfc3_use_stack:
    ADD T0, SB, R0
L_bc_34a1cfc3_done:
    MOVE RV0, S0
    MOVE RV1, T0
...
; LOAD: Pointer t28 has bank info: Dynamic("gep_new_bank_f20_op76_t28")
    LI T2, -1
    BEQ S0, T2, L_bc_64a4d306_use_global
    LI T3, -2
    BEQ S0, T3, L_bc_64a4d306_use_stack
    ADD T6, S0, R0
    BEQ R0, R0, L_bc_64a4d306_done
L_bc_64a4d306_use_global:
    ADD T6, GP, R0
    BEQ R0, R0, L_bc_64a4d306_done
L_bc_64a4d306_use_stack:
    ADD T6, SB, R0
L_bc_64a4d306_done:
; LOAD: Using bank register T6 for load
    LOAD T5, T6, T0
; Reload gep_new_bank_f20_op65_t25 from slot 24
    ...
    LOAD T2, SB, SC
    LI S2, -1
    BEQ T2, S2, L_bc_1b16f7ba_use_global
    LI T4, -2
    BEQ T2, T4, L_bc_1b16f7ba_use_stack
    ADD T3, T2, R0
    BEQ R0, R0, L_bc_1b16f7ba_done
L_bc_1b16f7ba_use_global:
    ADD T3, GP, R0
    BEQ R0, R0, L_bc_1b16f7ba_done
L_bc_1b16f7ba_use_stack:
    ADD T3, SB, R0
L_bc_1b16f7ba_done:
    STORE T5, T3, T7
...
; LOAD: Pointer t43 has bank info: Dynamic("gep_new_bank_f20_op118_t43")
    LI T6, -1
    BEQ S1, T6, L_bc_7282b1c8_use_global
    LI T0, -2
    BEQ S1, T0, L_bc_7282b1c8_use_stack
    ADD S0, S1, R0
    BEQ R0, R0, L_bc_7282b1c8_done
L_bc_7282b1c8_use_global:
    ADD S0, GP, R0
    BEQ R0, R0, L_bc_7282b1c8_done
L_bc_7282b1c8_use_stack:
    ADD S0, SB, R0
L_bc_7282b1c8_done:
; LOAD: Using bank register S0 for load
    LOAD S3, S0, S2
; Reload gep_new_bank_f20_op107_t40 from slot 44
    ...
    LOAD T6, SB, SC
    LI T7, -1
    BEQ T6, T7, L_bc_02457997_use_global
    LI T1, -2
    BEQ T6, T1, L_bc_02457997_use_stack
    ADD T0, T6, R0
    BEQ R0, R0, L_bc_02457997_done
L_bc_02457997_use_global:
    ADD T0, GP, R0
    BEQ R0, R0, L_bc_02457997_done
L_bc_02457997_use_stack:
    ADD T0, SB, R0
L_bc_02457997_done:
    STORE S3, T0, T5
...
; Spill gep_new_bank_f20_op118_t43 to slot 51
    ...
    STORE S1, SB, SC
    LI S1, -1
    BEQ S2, S1, L_bc_2fede798_use_global
; Spill load_f20_op119_t44_resolved_bank_20_f20_op120 to slot 52
    ADD SC, FP, R0
    ADDI SC, SC, 70
    STORE S0, SB, SC
    LI S0, -2
    BEQ S2, S0, L_bc_2fede798_use_stack
    ADD T4, S2, R0
    BEQ R0, R0, L_bc_2fede798_done
L_bc_2fede798_use_global:
    ADD T4, GP, R0
    BEQ R0, R0, L_bc_2fede798_done
L_bc_2fede798_use_stack:
    ADD T4, SB, R0
L_bc_2fede798_done:
    MOVE RV0, T7
    MOVE RV1, T4
...
; Recompute alloca t4 at FP+2
    ...
    LOAD S3, SB, S0
    LI S1, -1
    BEQ T3, S1, L_bc_29452684_use_global
; Spill load_f22_op12_t7_bank_val to slot 5
    ADD SC, FP, R0
    ADDI SC, SC, 20
    STORE T1, SB, SC
    LI T1, -2
    BEQ T3, T1, L_bc_29452684_use_stack
    ADD S2, T3, R0
    BEQ R0, R0, L_bc_29452684_done
L_bc_29452684_use_global:
    ADD S2, GP, R0
    BEQ R0, R0, L_bc_29452684_done
L_bc_29452684_use_stack:
    ADD S2, SB, R0
L_bc_29452684_done:
    STORE S3, S2, T4
...
; Spill t13 to slot 8
    ...
    STORE T0, SB, SC
    LI T0, -1
    BEQ T7, T0, L_bc_fbca8963_use_global
; Spill load_f22_op24_t12_bank_val to slot 9
    ADD SC, FP, R0
    ADDI SC, SC, 24
    STORE T5, SB, SC
    LI T5, -2
    BEQ T7, T5, L_bc_fbca8963_use_stack
    ADD S1, T7, R0
    BEQ R0, R0, L_bc_fbca8963_done
L_bc_fbca8963_use_global:
    ADD S1, GP, R0
    BEQ R0, R0, L_bc_fbca8963_done
L_bc_fbca8963_use_stack:
    ADD S1, SB, R0
L_bc_fbca8963_done:
    MOVE RV0, S0
    MOVE RV1, S1
...
; LOAD: Pointer t16 has bank info: Dynamic("gep_new_bank_f24_op40_t16")
    LI S1, -1
    BEQ T1, S1, L_bc_3848e192_use_global
    LI T2, -2
    BEQ T1, T2, L_bc_3848e192_use_stack
    ADD S0, T1, R0
    BEQ R0, R0, L_bc_3848e192_done
L_bc_3848e192_use_global:
    ADD S0, GP, R0
    BEQ R0, R0, L_bc_3848e192_done
L_bc_3848e192_use_stack:
    ADD S0, SB, R0
L_bc_3848e192_done:
; LOAD: Using bank register S0 for load
    LOAD T0, S0, S2
...
; LOAD: Pointer t20 has bank info: Dynamic("gep_new_bank_f24_op55_t20")
    LI T5, -1
    BEQ S0, T5, L_bc_d4469e53_use_global
    LI S2, -2
    BEQ S0, S2, L_bc_d4469e53_use_stack
    ADD T4, S0, R0
    BEQ R0, R0, L_bc_d4469e53_done
L_bc_d4469e53_use_global:
    ADD T4, GP, R0
    BEQ R0, R0, L_bc_d4469e53_done
L_bc_d4469e53_use_stack:
    ADD T4, SB, R0
L_bc_d4469e53_done:
...
; LOAD: Pointer t25 has bank info: Dynamic("gep_new_bank_f24_op72_t25")
    LI S3, -1
    BEQ S0, S3, L_bc_eaa5bf17_use_global
    LI T6, -2
    BEQ S0, T6, L_bc_eaa5bf17_use_stack
    ADD T2, S0, R0
    BEQ R0, R0, L_bc_eaa5bf17_done
L_bc_eaa5bf17_use_global:
    ADD T2, GP, R0
    BEQ R0, R0, L_bc_eaa5bf17_done
L_bc_eaa5bf17_use_stack:
    ADD T2, SB, R0
L_bc_eaa5bf17_done:
...
; LOAD: Pointer t29 has bank info: Dynamic("gep_new_bank_f24_op87_t29")
    LI T0, -1
    BEQ T2, T0, L_bc_705b40a2_use_global
    LI T1, -2
    BEQ T2, T1, L_bc_705b40a2_use_stack
    ADD S1, T2, R0
    BEQ R0, R0, L_bc_705b40a2_done
L_bc_705b40a2_use_global:
    ADD S1, GP, R0
    BEQ R0, R0, L_bc_705b40a2_done
L_bc_705b40a2_use_stack:
    ADD S1, SB, R0
L_bc_705b40a2_done:
; LOAD: Using bank register S1 for load
    LOAD S0, S1, S2
