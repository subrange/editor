...
; LOAD: Pointer t10 has bank info: Dynamic("gep_new_bank_f0_op33_t10")
    LI T2, -1
    BEQ S3, T2, L_bc_36fae391_use_global
    LI T6, -2
    BEQ S3, T6, L_bc_36fae391_use_stack
    ADD T3, S3, R0
    BEQ R0, R0, L_bc_36fae391_done
L_bc_36fae391_use_global:
    ADD T3, GP, R0
    BEQ R0, R0, L_bc_36fae391_done
L_bc_36fae391_use_stack:
    ADD T3, SB, R0
L_bc_36fae391_done:
...
; Reload gep_new_bank_f0_op22_t7 from slot 6
    ...
    LOAD T2, SB, SC
    LI T5, -1
    BEQ T2, T5, L_bc_9cec64e0_use_global
    LI S0, -2
    BEQ T2, S0, L_bc_9cec64e0_use_stack
    ADD T6, T2, R0
    BEQ R0, R0, L_bc_9cec64e0_done
L_bc_9cec64e0_use_global:
    ADD T6, GP, R0
    BEQ R0, R0, L_bc_9cec64e0_done
L_bc_9cec64e0_use_stack:
    ADD T6, SB, R0
L_bc_9cec64e0_done:
    STORE T0, T6, T4
...
; LOAD: Pointer t14 has bank info: Dynamic("gep_new_bank_f0_op52_t14")
    LI T3, -1
    BEQ T2, T3, L_bc_8777aad6_use_global
    LI T0, -2
    BEQ T2, T0, L_bc_8777aad6_use_stack
    ADD S3, T2, R0
    BEQ R0, R0, L_bc_8777aad6_done
L_bc_8777aad6_use_global:
    ADD S3, GP, R0
    BEQ R0, R0, L_bc_8777aad6_done
L_bc_8777aad6_use_stack:
    ADD S3, SB, R0
L_bc_8777aad6_done:
...
; Spill load_f0_op45_t12_bank_val to slot 20
    ...
    STORE S1, SB, SC
    LI S0, -1
    BEQ T0, S0, L_bc_9042170d_use_global
; Spill t13 to slot 21
    ADD SC, FP, R0
    ADDI SC, SC, 34
    STORE T1, SB, SC
    LI T1, -2
    BEQ T0, T1, L_bc_9042170d_use_stack
    ADD T5, T0, R0
    BEQ R0, R0, L_bc_9042170d_done
L_bc_9042170d_use_global:
    ADD T5, GP, R0
    BEQ R0, R0, L_bc_9042170d_done
L_bc_9042170d_use_stack:
    ADD T5, SB, R0
L_bc_9042170d_done:
    MOVE RV0, T3
    MOVE RV1, T5
...
; LOAD: Pointer t12 has bank info: Dynamic("gep_new_bank_f2_op28_t12")
    LI T7, -1
    BEQ S2, T7, L_bc_44926fca_use_global
    LI T4, -2
    BEQ S2, T4, L_bc_44926fca_use_stack
    ADD T1, S2, R0
    BEQ R0, R0, L_bc_44926fca_done
L_bc_44926fca_use_global:
    ADD T1, GP, R0
    BEQ R0, R0, L_bc_44926fca_done
L_bc_44926fca_use_stack:
    ADD T1, SB, R0
L_bc_44926fca_done:
...
; LOAD: Pointer t19 has bank info: Dynamic("gep_new_bank_f2_op54_t19")
    LI T4, -1
    BEQ S2, T4, L_bc_c72f53c0_use_global
    LI S3, -2
    BEQ S2, S3, L_bc_c72f53c0_use_stack
    ADD T7, S2, R0
    BEQ R0, R0, L_bc_c72f53c0_done
L_bc_c72f53c0_use_global:
    ADD T7, GP, R0
    BEQ R0, R0, L_bc_c72f53c0_done
L_bc_c72f53c0_use_stack:
    ADD T7, SB, R0
L_bc_c72f53c0_done:
...
; Reload gep_new_bank_f2_op43_t16 from slot 15
    ...
    LOAD T4, SB, SC
    LI T3, -1
    BEQ T4, T3, L_bc_b5ed98ed_use_global
    LI S0, -2
    BEQ T4, S0, L_bc_b5ed98ed_use_stack
    ADD S3, T4, R0
    BEQ R0, R0, L_bc_b5ed98ed_done
L_bc_b5ed98ed_use_global:
    ADD S3, GP, R0
    BEQ R0, R0, L_bc_b5ed98ed_done
L_bc_b5ed98ed_use_stack:
    ADD S3, SB, R0
L_bc_b5ed98ed_done:
    STORE T2, S3, S1
...
; GEP: Setting bank info for t26 to Dynamic("gep_new_bank_f2_op77_t26")
    LI S2, 0
    LI T2, -1
    BEQ T4, T2, L_bc_5e322aec_use_global
    LI S1, -2
    BEQ T4, S1, L_bc_5e322aec_use_stack
    ADD T7, T4, R0
    BEQ R0, R0, L_bc_5e322aec_done
L_bc_5e322aec_use_global:
    ADD T7, GP, R0
    BEQ R0, R0, L_bc_5e322aec_done
L_bc_5e322aec_use_stack:
    ADD T7, SB, R0
L_bc_5e322aec_done:
    STORE S2, T7, T1
...
; Spill load_f2_op70_t24_bank_val to slot 31
    ...
    STORE T5, SB, SC
    LI T5, -1
    BEQ T0, T5, L_bc_c2e32ce5_use_global
...
; Spill gep_new_bank_f2_op77_t26 to slot 33
    ...
    STORE T4, SB, SC
    LI T1, -2
    BEQ T0, T1, L_bc_c2e32ce5_use_stack
    ADD S0, T0, R0
    BEQ R0, R0, L_bc_c2e32ce5_done
L_bc_c2e32ce5_use_global:
    ADD S0, GP, R0
    BEQ R0, R0, L_bc_c2e32ce5_done
L_bc_c2e32ce5_use_stack:
    ADD S0, SB, R0
L_bc_c2e32ce5_done:
    MOVE RV0, S2
    MOVE RV1, S0
...
; LOAD: Pointer t5 has bank info: Dynamic("gep_new_bank_f4_op17_t5")
    LI T7, -1
    BEQ T4, T7, L_bc_29c124b9_use_global
    LI S0, -2
    BEQ T4, S0, L_bc_29c124b9_use_stack
    ADD S1, T4, R0
    BEQ R0, R0, L_bc_29c124b9_done
L_bc_29c124b9_use_global:
    ADD S1, GP, R0
    BEQ R0, R0, L_bc_29c124b9_done
L_bc_29c124b9_use_stack:
    ADD S1, SB, R0
L_bc_29c124b9_done:
...
; LOAD: Pointer t7 has bank info: Dynamic("gep_new_bank_f6_op22_t7")
    LI T7, -1
    BEQ S3, T7, L_bc_0e23ed11_use_global
    LI S1, -2
    BEQ S3, S1, L_bc_0e23ed11_use_stack
    ADD T5, S3, R0
    BEQ R0, R0, L_bc_0e23ed11_done
L_bc_0e23ed11_use_global:
    ADD T5, GP, R0
    BEQ R0, R0, L_bc_0e23ed11_done
L_bc_0e23ed11_use_stack:
    ADD T5, SB, R0
L_bc_0e23ed11_done:
...
; LOAD: Pointer t12 has bank info: Dynamic("gep_new_bank_f6_op39_t12")
    LI T0, -1
    BEQ T5, T0, L_bc_edc45da4_use_global
    LI T4, -2
    BEQ T5, T4, L_bc_edc45da4_use_stack
    ADD T6, T5, R0
    BEQ R0, R0, L_bc_edc45da4_done
L_bc_edc45da4_use_global:
    ADD T6, GP, R0
    BEQ R0, R0, L_bc_edc45da4_done
L_bc_edc45da4_use_stack:
    ADD T6, SB, R0
L_bc_edc45da4_done:
...
; LOAD: Pointer t18 has bank info: Dynamic("gep_new_bank_f6_op56_t18")
    LI T7, -1
    BEQ T5, T7, L_bc_9bca9571_use_global
    LI T3, -2
    BEQ T5, T3, L_bc_9bca9571_use_stack
    ADD S2, T5, R0
    BEQ R0, R0, L_bc_9bca9571_done
L_bc_9bca9571_use_global:
    ADD S2, GP, R0
    BEQ R0, R0, L_bc_9bca9571_done
L_bc_9bca9571_use_stack:
    ADD S2, SB, R0
L_bc_9bca9571_done:
...
; LOAD: Pointer t22 has bank info: Dynamic("gep_new_bank_f6_op71_t22")
    LI T4, -1
    BEQ S2, T4, L_bc_4fb36bb3_use_global
    LI S3, -2
    BEQ S2, S3, L_bc_4fb36bb3_use_stack
    ADD S1, S2, R0
    BEQ R0, R0, L_bc_4fb36bb3_done
L_bc_4fb36bb3_use_global:
    ADD S1, GP, R0
    BEQ R0, R0, L_bc_4fb36bb3_done
L_bc_4fb36bb3_use_stack:
    ADD S1, SB, R0
L_bc_4fb36bb3_done:
; LOAD: Using bank register S1 for load
    LOAD T5, S1, T0
...
; LOAD: Pointer t27 has bank info: Dynamic("gep_new_bank_f6_op88_t27")
    LI T6, -1
    BEQ S2, T6, L_bc_41cf6713_use_global
    LI T1, -2
    BEQ S2, T1, L_bc_41cf6713_use_stack
    ADD T3, S2, R0
    BEQ R0, R0, L_bc_41cf6713_done
L_bc_41cf6713_use_global:
    ADD T3, GP, R0
    BEQ R0, R0, L_bc_41cf6713_done
L_bc_41cf6713_use_stack:
    ADD T3, SB, R0
L_bc_41cf6713_done:
; LOAD: Using bank register T3 for load
    LOAD T0, T3, T5
...
; LOAD: Pointer t31 has bank info: Dynamic("gep_new_bank_f6_op103_t31")
    LI T2, -1
    BEQ T3, T2, L_bc_9a5d89ba_use_global
    LI T5, -2
    BEQ T3, T5, L_bc_9a5d89ba_use_stack
    ADD S0, T3, R0
    BEQ R0, R0, L_bc_9a5d89ba_done
L_bc_9a5d89ba_use_global:
    ADD S0, GP, R0
    BEQ R0, R0, L_bc_9a5d89ba_done
L_bc_9a5d89ba_use_stack:
    ADD S0, SB, R0
L_bc_9a5d89ba_done:
...
; LOAD: Pointer t40 has bank info: Dynamic("gep_new_bank_f6_op123_t40")
    LI T3, -1
    BEQ T5, T3, L_bc_c45709b3_use_global
    LI S0, -2
    BEQ T5, S0, L_bc_c45709b3_use_stack
    ADD S3, T5, R0
    BEQ R0, R0, L_bc_c45709b3_done
L_bc_c45709b3_use_global:
    ADD S3, GP, R0
    BEQ R0, R0, L_bc_c45709b3_done
L_bc_c45709b3_use_stack:
    ADD S3, SB, R0
L_bc_c45709b3_done:
; LOAD: Using bank register S3 for load
    LOAD T0, S3, T4
...
; LOAD: Pointer t44 has bank info: Dynamic("gep_new_bank_f6_op138_t44")
    LI T1, -1
    BEQ S3, T1, L_bc_f92ec875_use_global
    LI T4, -2
    BEQ S3, T4, L_bc_f92ec875_use_stack
    ADD S1, S3, R0
    BEQ R0, R0, L_bc_f92ec875_done
L_bc_f92ec875_use_global:
    ADD S1, GP, R0
    BEQ R0, R0, L_bc_f92ec875_done
L_bc_f92ec875_use_stack:
    ADD S1, SB, R0
L_bc_f92ec875_done:
; LOAD: Using bank register S1 for load
    LOAD T5, S1, T7
...
; LOAD: Pointer t12 has bank info: Dynamic("gep_new_bank_f8_op28_t12")
    LI T7, -1
    BEQ S2, T7, L_bc_d4b2b162_use_global
    LI T4, -2
    BEQ S2, T4, L_bc_d4b2b162_use_stack
    ADD T1, S2, R0
    BEQ R0, R0, L_bc_d4b2b162_done
L_bc_d4b2b162_use_global:
    ADD T1, GP, R0
    BEQ R0, R0, L_bc_d4b2b162_done
L_bc_d4b2b162_use_stack:
    ADD T1, SB, R0
L_bc_d4b2b162_done:
; LOAD: Using bank register T1 for load
    LOAD S3, T1, T0
...
; LOAD: Pointer t17 has bank info: Dynamic("gep_new_bank_f8_op45_t17")
    LI T6, -1
    BEQ T1, T6, L_bc_55b30ef9_use_global
    LI T0, -2
    BEQ T1, T0, L_bc_55b30ef9_use_stack
    ADD T5, T1, R0
    BEQ R0, R0, L_bc_55b30ef9_done
L_bc_55b30ef9_use_global:
    ADD T5, GP, R0
    BEQ R0, R0, L_bc_55b30ef9_done
L_bc_55b30ef9_use_stack:
    ADD T5, SB, R0
L_bc_55b30ef9_done:
; LOAD: Using bank register T5 for load
    LOAD S2, T5, T3
...
; LOAD: Pointer t23 has bank info: Dynamic("gep_new_bank_f8_op62_t23")
    LI T7, -1
    BEQ T1, T7, L_bc_b3fc1d4e_use_global
    LI T2, -2
    BEQ T1, T2, L_bc_b3fc1d4e_use_stack
    ADD S1, T1, R0
    BEQ R0, R0, L_bc_b3fc1d4e_done
L_bc_b3fc1d4e_use_global:
    ADD S1, GP, R0
    BEQ R0, R0, L_bc_b3fc1d4e_done
L_bc_b3fc1d4e_use_stack:
    ADD S1, SB, R0
L_bc_b3fc1d4e_done:
; LOAD: Using bank register S1 for load
    LOAD T3, S1, S2
...
; LOAD: Pointer t27 has bank info: Dynamic("gep_new_bank_f8_op77_t27")
    LI T0, -1
    BEQ S1, T0, L_bc_b18f2b2f_use_global
    LI S2, -2
    BEQ S1, S2, L_bc_b18f2b2f_use_stack
    ADD S0, S1, R0
    BEQ R0, R0, L_bc_b18f2b2f_done
L_bc_b18f2b2f_use_global:
    ADD S0, GP, R0
    BEQ R0, R0, L_bc_b18f2b2f_done
L_bc_b18f2b2f_use_stack:
    ADD S0, SB, R0
L_bc_b18f2b2f_done:
; LOAD: Using bank register S0 for load
    LOAD T1, S0, T6
...
; LOAD: Pointer t32 has bank info: Dynamic("gep_new_bank_f8_op92_t32")
    LI S3, -1
    BEQ S0, S3, L_bc_0a6130dd_use_global
    LI T6, -2
    BEQ S0, T6, L_bc_0a6130dd_use_stack
    ADD T5, S0, R0
    BEQ R0, R0, L_bc_0a6130dd_done
L_bc_0a6130dd_use_global:
    ADD T5, GP, R0
    BEQ R0, R0, L_bc_0a6130dd_done
L_bc_0a6130dd_use_stack:
    ADD T5, SB, R0
L_bc_0a6130dd_done:
; LOAD: Using bank register T5 for load
    LOAD S1, T5, T2
...
; LOAD: Pointer t36 has bank info: Dynamic("gep_new_bank_f8_op107_t36")
    LI T4, -1
    BEQ T5, T4, L_bc_69b35716_use_global
    LI T2, -2
    BEQ T5, T2, L_bc_69b35716_use_stack
    ADD T1, T5, R0
    BEQ R0, R0, L_bc_69b35716_done
L_bc_69b35716_use_global:
    ADD T1, GP, R0
    BEQ R0, R0, L_bc_69b35716_done
L_bc_69b35716_use_stack:
    ADD T1, SB, R0
L_bc_69b35716_done:
; LOAD: Using bank register T1 for load
    LOAD S0, T1, S2
...
; LOAD: Pointer t41 has bank info: Dynamic("gep_new_bank_f8_op124_t41")
    LI T3, -1
    BEQ T5, T3, L_bc_838a9dcd_use_global
    LI T0, -2
    BEQ T5, T0, L_bc_838a9dcd_use_stack
    ADD T6, T5, R0
    BEQ R0, R0, L_bc_838a9dcd_done
L_bc_838a9dcd_use_global:
    ADD T6, GP, R0
    BEQ R0, R0, L_bc_838a9dcd_done
L_bc_838a9dcd_use_stack:
    ADD T6, SB, R0
L_bc_838a9dcd_done:
; LOAD: Using bank register T6 for load
    LOAD S2, T6, S0
...
; LOAD: Pointer t45 has bank info: Dynamic("gep_new_bank_f8_op139_t45")
    LI S1, -1
    BEQ T6, S1, L_bc_7eb5ed91_use_global
    LI S0, -2
    BEQ T6, S0, L_bc_7eb5ed91_use_stack
    ADD S3, T6, R0
    BEQ R0, R0, L_bc_7eb5ed91_done
L_bc_7eb5ed91_use_global:
    ADD S3, GP, R0
    BEQ R0, R0, L_bc_7eb5ed91_done
L_bc_7eb5ed91_use_stack:
    ADD S3, SB, R0
L_bc_7eb5ed91_done:
; LOAD: Using bank register S3 for load
    LOAD T5, S3, T2
...
; LOAD: Pointer t15 has bank info: Dynamic("gep_new_bank_f10_op40_t15")
    LI T7, -1
    BEQ S2, T7, L_bc_636f722a_use_global
    LI T3, -2
    BEQ S2, T3, L_bc_636f722a_use_stack
    ADD T6, S2, R0
    BEQ R0, R0, L_bc_636f722a_done
L_bc_636f722a_use_global:
    ADD T6, GP, R0
    BEQ R0, R0, L_bc_636f722a_done
L_bc_636f722a_use_stack:
    ADD T6, SB, R0
L_bc_636f722a_done:
; LOAD: Using bank register T6 for load
    LOAD T5, T6, RV0
    LI T3, -1
    BEQ T4, T3, L_bc_9e4628fc_use_global
    LI S0, -2
    BEQ T4, S0, L_bc_9e4628fc_use_stack
    ADD T7, T4, R0
    BEQ R0, R0, L_bc_9e4628fc_done
L_bc_9e4628fc_use_global:
    ADD T7, GP, R0
    BEQ R0, R0, L_bc_9e4628fc_done
L_bc_9e4628fc_use_stack:
    ADD T7, SB, R0
L_bc_9e4628fc_done:
    STORE T5, T7, T2
...
; LOAD: Pointer t19 has bank info: Dynamic("gep_new_bank_f10_op59_t19")
    LI S2, -1
    BEQ T2, S2, L_bc_f19c4633_use_global
    LI T6, -2
    BEQ T2, T6, L_bc_f19c4633_use_stack
    ADD RV0, T2, R0
    BEQ R0, R0, L_bc_f19c4633_done
L_bc_f19c4633_use_global:
    ADD RV0, GP, R0
    BEQ R0, R0, L_bc_f19c4633_done
L_bc_f19c4633_use_stack:
    ADD RV0, SB, R0
L_bc_f19c4633_done:
...
; Spill store_f10_op45_resolved_bank_10_f10_op46 to slot 22
    ...
    STORE T7, SB, SC
    LI T7, -1
    BEQ T6, T7, L_bc_ace8bcbe_use_global
...
; Spill load_f10_op52_t17_bank_val to slot 24
    ...
    STORE T0, SB, SC
    LI S0, -2
    BEQ T6, S0, L_bc_ace8bcbe_use_stack
    ADD T3, T6, R0
    BEQ R0, R0, L_bc_ace8bcbe_done
L_bc_ace8bcbe_use_global:
    ADD T3, GP, R0
    BEQ R0, R0, L_bc_ace8bcbe_done
L_bc_ace8bcbe_use_stack:
    ADD T3, SB, R0
L_bc_ace8bcbe_done:
    MOVE RV0, S2
    MOVE RV1, T3
...
; LOAD: Pointer t15 has bank info: Dynamic("gep_new_bank_f12_op33_t15")
    LI T7, -1
    BEQ S3, T7, L_bc_54ea8ddc_use_global
    LI S1, -2
    BEQ S3, S1, L_bc_54ea8ddc_use_stack
    ADD S0, S3, R0
    BEQ R0, R0, L_bc_54ea8ddc_done
L_bc_54ea8ddc_use_global:
    ADD S0, GP, R0
    BEQ R0, R0, L_bc_54ea8ddc_done
L_bc_54ea8ddc_use_stack:
    ADD S0, SB, R0
L_bc_54ea8ddc_done:
; LOAD: Using bank register S0 for load
    LOAD S2, S0, T5
...
; LOAD: Pointer t25 has bank info: Dynamic("gep_new_bank_f12_op63_t25")
    LI T0, -1
    BEQ S2, T0, L_bc_d0a7e720_use_global
    LI S1, -2
    BEQ S2, S1, L_bc_d0a7e720_use_stack
    ADD T7, S2, R0
    BEQ R0, R0, L_bc_d0a7e720_done
L_bc_d0a7e720_use_global:
    ADD T7, GP, R0
    BEQ R0, R0, L_bc_d0a7e720_done
L_bc_d0a7e720_use_stack:
    ADD T7, SB, R0
L_bc_d0a7e720_done:
; LOAD: Using bank register T7 for load
    LOAD T4, T7, S0
    LI S1, -1
    BEQ S3, S1, L_bc_45d0744a_use_global
    LI T3, -2
    BEQ S3, T3, L_bc_45d0744a_use_stack
    ADD T0, S3, R0
    BEQ R0, R0, L_bc_45d0744a_done
L_bc_45d0744a_use_global:
    ADD T0, GP, R0
    BEQ R0, R0, L_bc_45d0744a_done
L_bc_45d0744a_use_stack:
    ADD T0, SB, R0
L_bc_45d0744a_done:
    STORE T4, T0, RV0
...
; GEP: Setting bank info for t35 to Dynamic("gep_new_bank_f12_op89_t35")
    LI T4, 0
    LI S3, -1
    BEQ T3, S3, L_bc_6e81f326_use_global
    LI T0, -2
    BEQ T3, T0, L_bc_6e81f326_use_stack
    ADD RV0, T3, R0
    BEQ R0, R0, L_bc_6e81f326_done
L_bc_6e81f326_use_global:
    ADD RV0, GP, R0
    BEQ R0, R0, L_bc_6e81f326_done
L_bc_6e81f326_use_stack:
    ADD RV0, SB, R0
L_bc_6e81f326_done:
    STORE T4, RV0, T7
...
; Spill t30 to slot 33
    ...
    STORE T6, SB, SC
    LI T6, -1
    BEQ T4, T6, L_bc_ac65bc6b_use_global
    LI T2, -2
    BEQ T4, T2, L_bc_ac65bc6b_use_stack
    ADD T0, T4, R0
    BEQ R0, R0, L_bc_ac65bc6b_done
L_bc_ac65bc6b_use_global:
    ADD T0, GP, R0
    BEQ R0, R0, L_bc_ac65bc6b_done
L_bc_ac65bc6b_use_stack:
    ADD T0, SB, R0
L_bc_ac65bc6b_done:
    MOVE RV0, S3
    MOVE RV1, T0
...
; LOAD: Pointer t7 has bank info: Dynamic("gep_new_bank_f14_op19_t7")
    LI T7, -1
    BEQ S3, T7, L_bc_3b73a5f2_use_global
    LI S1, -2
    BEQ S3, S1, L_bc_3b73a5f2_use_stack
    ADD T6, S3, R0
    BEQ R0, R0, L_bc_3b73a5f2_done
L_bc_3b73a5f2_use_global:
    ADD T6, GP, R0
    BEQ R0, R0, L_bc_3b73a5f2_done
L_bc_3b73a5f2_use_stack:
    ADD T6, SB, R0
L_bc_3b73a5f2_done:
; LOAD: Using bank register T6 for load
    LOAD T2, T6, T5
...
; LOAD: Pointer t11 has bank info: Dynamic("gep_new_bank_f14_op34_t11")
    LI S0, -1
    BEQ S3, S0, L_bc_2b50f648_use_global
    LI T1, -2
    BEQ S3, T1, L_bc_2b50f648_use_stack
    ADD T3, S3, R0
    BEQ R0, R0, L_bc_2b50f648_done
L_bc_2b50f648_use_global:
    ADD T3, GP, R0
    BEQ R0, R0, L_bc_2b50f648_done
L_bc_2b50f648_use_stack:
    ADD T3, SB, R0
L_bc_2b50f648_done:
; LOAD: Using bank register T3 for load
    LOAD T5, T3, S2
...
; GEP: Setting bank info for t17 to Dynamic("gep_new_bank_f14_op53_t17")
    LI T2, -1
    BEQ S3, T2, L_bc_76253cfb_use_global
    LI T0, -2
    BEQ S3, T0, L_bc_76253cfb_use_stack
    ADD S1, S3, R0
    BEQ R0, R0, L_bc_76253cfb_done
L_bc_76253cfb_use_global:
    ADD S1, GP, R0
    BEQ R0, R0, L_bc_76253cfb_done
L_bc_76253cfb_use_stack:
    ADD S1, SB, R0
L_bc_76253cfb_done:
    MOVE RV0, T1
    MOVE RV1, S1
...
; GEP: Setting bank info for t26 to Dynamic("gep_new_bank_f14_op76_t26")
    LI T1, -1
    BEQ T2, T1, L_bc_4907457d_use_global
    LI S3, -2
    BEQ T2, S3, L_bc_4907457d_use_stack
    ADD T5, T2, R0
    BEQ R0, R0, L_bc_4907457d_done
L_bc_4907457d_use_global:
    ADD T5, GP, R0
    BEQ R0, R0, L_bc_4907457d_done
L_bc_4907457d_use_stack:
    ADD T5, SB, R0
L_bc_4907457d_done:
    MOVE RV0, S0
    MOVE RV1, T5
...
; LOAD: Pointer t8 has bank info: Dynamic("gep_new_bank_f16_op21_t8")
    LI T7, -1
    BEQ S3, T7, L_bc_b7d05c6e_use_global
    LI S1, -2
    BEQ S3, S1, L_bc_b7d05c6e_use_stack
    ADD T6, S3, R0
    BEQ R0, R0, L_bc_b7d05c6e_done
L_bc_b7d05c6e_use_global:
    ADD T6, GP, R0
    BEQ R0, R0, L_bc_b7d05c6e_done
L_bc_b7d05c6e_use_stack:
    ADD T6, SB, R0
L_bc_b7d05c6e_done:
; LOAD: Using bank register T6 for load
    LOAD T0, T6, T4
...
; LOAD: Pointer t12 has bank info: Dynamic("gep_new_bank_f16_op36_t12")
    LI T3, -1
    BEQ S3, T3, L_bc_59e4d6e0_use_global
    LI S0, -2
    BEQ S3, S0, L_bc_59e4d6e0_use_stack
    ADD T1, S3, R0
    BEQ R0, R0, L_bc_59e4d6e0_done
L_bc_59e4d6e0_use_global:
    ADD T1, GP, R0
    BEQ R0, R0, L_bc_59e4d6e0_done
L_bc_59e4d6e0_use_stack:
    ADD T1, SB, R0
L_bc_59e4d6e0_done:
; LOAD: Using bank register T1 for load
    LOAD T4, T1, S2
...
; GEP: Setting bank info for t27 to Dynamic("gep_new_bank_f16_op77_t27")
    LI T4, -1
    BEQ S2, T4, L_bc_68f7d8f2_use_global
    LI S0, -2
    BEQ S2, S0, L_bc_68f7d8f2_use_stack
    ADD T5, S2, R0
    BEQ R0, R0, L_bc_68f7d8f2_done
L_bc_68f7d8f2_use_global:
    ADD T5, GP, R0
    BEQ R0, R0, L_bc_68f7d8f2_done
L_bc_68f7d8f2_use_stack:
    ADD T5, SB, R0
L_bc_68f7d8f2_done:
    MOVE RV0, T7
    MOVE RV1, T5
...
; Bank value in T2 - tags: -1 = Global, -2 = Stack, positive = dynamic
    LI S0, -1
    BEQ T2, S0, L_bc_d8cdc8ea_use_global
; Spill t22 to slot 26
    ADD SC, FP, R0
    ADDI SC, SC, 40
    STORE T3, SB, SC
    LI T3, -2
    BEQ T2, T3, L_bc_d8cdc8ea_use_stack
    ADD S1, T2, R0
    BEQ R0, R0, L_bc_d8cdc8ea_done
L_bc_d8cdc8ea_use_global:
    ADD S1, GP, R0
    BEQ R0, R0, L_bc_d8cdc8ea_done
L_bc_d8cdc8ea_use_stack:
    ADD S1, SB, R0
L_bc_d8cdc8ea_done:
    MOVE RV0, T4
    MOVE RV1, S1
...
; LOAD: Pointer t19 has bank info: Dynamic("gep_new_bank_f18_op51_t19")
    LI T7, -1
    BEQ T1, T7, L_bc_6a4c77a9_use_global
    LI T4, -2
    BEQ T1, T4, L_bc_6a4c77a9_use_stack
    ADD T6, T1, R0
    BEQ R0, R0, L_bc_6a4c77a9_done
L_bc_6a4c77a9_use_global:
    ADD T6, GP, R0
    BEQ R0, R0, L_bc_6a4c77a9_done
L_bc_6a4c77a9_use_stack:
    ADD T6, SB, R0
L_bc_6a4c77a9_done:
; LOAD: Using bank register T6 for load
    LOAD T5, T6, S3
; Reload gep_new_bank_f18_op40_t16 from slot 13
    ...
    LOAD T7, SB, SC
    LI S0, -1
    BEQ T7, S0, L_bc_3d349d44_use_global
    LI T3, -2
    BEQ T7, T3, L_bc_3d349d44_use_stack
    ADD T4, T7, R0
    BEQ R0, R0, L_bc_3d349d44_done
L_bc_3d349d44_use_global:
    ADD T4, GP, R0
    BEQ R0, R0, L_bc_3d349d44_done
L_bc_3d349d44_use_stack:
    ADD T4, SB, R0
L_bc_3d349d44_done:
    STORE T5, T4, S2
...
; Spill gep_new_bank_f18_op51_t19 to slot 20
    ...
    STORE T1, SB, SC
    LI T1, -1
    BEQ S3, T1, L_bc_91501426_use_global
; Spill load_f18_op52_t20_resolved_bank_18_f18_op53 to slot 21
    ADD SC, FP, R0
    ADDI SC, SC, 39
    STORE T6, SB, SC
    LI T6, -2
    BEQ S3, T6, L_bc_91501426_use_stack
    ADD T0, S3, R0
    BEQ R0, R0, L_bc_91501426_done
L_bc_91501426_use_global:
    ADD T0, GP, R0
    BEQ R0, R0, L_bc_91501426_done
L_bc_91501426_use_stack:
    ADD T0, SB, R0
L_bc_91501426_done:
    MOVE RV0, S0
    MOVE RV1, T0
...
; LOAD: Pointer t28 has bank info: Dynamic("gep_new_bank_f20_op76_t28")
    LI T2, -1
    BEQ S0, T2, L_bc_107e8c24_use_global
    LI T3, -2
    BEQ S0, T3, L_bc_107e8c24_use_stack
    ADD T6, S0, R0
    BEQ R0, R0, L_bc_107e8c24_done
L_bc_107e8c24_use_global:
    ADD T6, GP, R0
    BEQ R0, R0, L_bc_107e8c24_done
L_bc_107e8c24_use_stack:
    ADD T6, SB, R0
L_bc_107e8c24_done:
; LOAD: Using bank register T6 for load
    LOAD T5, T6, T0
; Reload gep_new_bank_f20_op65_t25 from slot 24
    ...
    LOAD T2, SB, SC
    LI S2, -1
    BEQ T2, S2, L_bc_584d282b_use_global
    LI T4, -2
    BEQ T2, T4, L_bc_584d282b_use_stack
    ADD T3, T2, R0
    BEQ R0, R0, L_bc_584d282b_done
L_bc_584d282b_use_global:
    ADD T3, GP, R0
    BEQ R0, R0, L_bc_584d282b_done
L_bc_584d282b_use_stack:
    ADD T3, SB, R0
L_bc_584d282b_done:
    STORE T5, T3, T7
...
; LOAD: Pointer t43 has bank info: Dynamic("gep_new_bank_f20_op118_t43")
    LI T6, -1
    BEQ S1, T6, L_bc_a59dc189_use_global
    LI T0, -2
    BEQ S1, T0, L_bc_a59dc189_use_stack
    ADD S0, S1, R0
    BEQ R0, R0, L_bc_a59dc189_done
L_bc_a59dc189_use_global:
    ADD S0, GP, R0
    BEQ R0, R0, L_bc_a59dc189_done
L_bc_a59dc189_use_stack:
    ADD S0, SB, R0
L_bc_a59dc189_done:
; LOAD: Using bank register S0 for load
    LOAD S3, S0, S2
; Reload gep_new_bank_f20_op107_t40 from slot 44
    ...
    LOAD T6, SB, SC
    LI T7, -1
    BEQ T6, T7, L_bc_858dedaa_use_global
    LI T1, -2
    BEQ T6, T1, L_bc_858dedaa_use_stack
    ADD T0, T6, R0
    BEQ R0, R0, L_bc_858dedaa_done
L_bc_858dedaa_use_global:
    ADD T0, GP, R0
    BEQ R0, R0, L_bc_858dedaa_done
L_bc_858dedaa_use_stack:
    ADD T0, SB, R0
L_bc_858dedaa_done:
    STORE S3, T0, T5
...
; Spill gep_new_bank_f20_op118_t43 to slot 51
    ...
    STORE S1, SB, SC
    LI S1, -1
    BEQ S2, S1, L_bc_2f7e4c38_use_global
; Spill load_f20_op119_t44_resolved_bank_20_f20_op120 to slot 52
    ADD SC, FP, R0
    ADDI SC, SC, 70
    STORE S0, SB, SC
    LI S0, -2
    BEQ S2, S0, L_bc_2f7e4c38_use_stack
    ADD T4, S2, R0
    BEQ R0, R0, L_bc_2f7e4c38_done
L_bc_2f7e4c38_use_global:
    ADD T4, GP, R0
    BEQ R0, R0, L_bc_2f7e4c38_done
L_bc_2f7e4c38_use_stack:
    ADD T4, SB, R0
L_bc_2f7e4c38_done:
    MOVE RV0, T7
    MOVE RV1, T4
...
; Recompute alloca t4 at FP+2
    ...
    LOAD S3, SB, S0
    LI S1, -1
    BEQ T3, S1, L_bc_a8eb3d71_use_global
; Spill load_f22_op12_t7_bank_val to slot 5
    ADD SC, FP, R0
    ADDI SC, SC, 20
    STORE T1, SB, SC
    LI T1, -2
    BEQ T3, T1, L_bc_a8eb3d71_use_stack
    ADD S2, T3, R0
    BEQ R0, R0, L_bc_a8eb3d71_done
L_bc_a8eb3d71_use_global:
    ADD S2, GP, R0
    BEQ R0, R0, L_bc_a8eb3d71_done
L_bc_a8eb3d71_use_stack:
    ADD S2, SB, R0
L_bc_a8eb3d71_done:
    STORE S3, S2, T4
...
; Spill t13 to slot 8
    ...
    STORE T0, SB, SC
    LI T0, -1
    BEQ T7, T0, L_bc_2f11a26c_use_global
; Spill load_f22_op24_t12_bank_val to slot 9
    ADD SC, FP, R0
    ADDI SC, SC, 24
    STORE T5, SB, SC
    LI T5, -2
    BEQ T7, T5, L_bc_2f11a26c_use_stack
    ADD S1, T7, R0
    BEQ R0, R0, L_bc_2f11a26c_done
L_bc_2f11a26c_use_global:
    ADD S1, GP, R0
    BEQ R0, R0, L_bc_2f11a26c_done
L_bc_2f11a26c_use_stack:
    ADD S1, SB, R0
L_bc_2f11a26c_done:
    MOVE RV0, S0
    MOVE RV1, S1
...
; LOAD: Pointer t16 has bank info: Dynamic("gep_new_bank_f24_op40_t16")
    LI S1, -1
    BEQ T1, S1, L_bc_57b027ab_use_global
    LI T2, -2
    BEQ T1, T2, L_bc_57b027ab_use_stack
    ADD S0, T1, R0
    BEQ R0, R0, L_bc_57b027ab_done
L_bc_57b027ab_use_global:
    ADD S0, GP, R0
    BEQ R0, R0, L_bc_57b027ab_done
L_bc_57b027ab_use_stack:
    ADD S0, SB, R0
L_bc_57b027ab_done:
; LOAD: Using bank register S0 for load
    LOAD T0, S0, S2
...
; LOAD: Pointer t20 has bank info: Dynamic("gep_new_bank_f24_op55_t20")
    LI T5, -1
    BEQ S0, T5, L_bc_0344eb7b_use_global
    LI S2, -2
    BEQ S0, S2, L_bc_0344eb7b_use_stack
    ADD T4, S0, R0
    BEQ R0, R0, L_bc_0344eb7b_done
L_bc_0344eb7b_use_global:
    ADD T4, GP, R0
    BEQ R0, R0, L_bc_0344eb7b_done
L_bc_0344eb7b_use_stack:
    ADD T4, SB, R0
L_bc_0344eb7b_done:
...
; LOAD: Pointer t25 has bank info: Dynamic("gep_new_bank_f24_op72_t25")
    LI S3, -1
    BEQ S0, S3, L_bc_757b7edf_use_global
    LI T6, -2
    BEQ S0, T6, L_bc_757b7edf_use_stack
    ADD T2, S0, R0
    BEQ R0, R0, L_bc_757b7edf_done
L_bc_757b7edf_use_global:
    ADD T2, GP, R0
    BEQ R0, R0, L_bc_757b7edf_done
L_bc_757b7edf_use_stack:
    ADD T2, SB, R0
L_bc_757b7edf_done:
...
; LOAD: Pointer t29 has bank info: Dynamic("gep_new_bank_f24_op87_t29")
    LI T0, -1
    BEQ T2, T0, L_bc_a5a9884c_use_global
    LI T1, -2
    BEQ T2, T1, L_bc_a5a9884c_use_stack
    ADD S1, T2, R0
    BEQ R0, R0, L_bc_a5a9884c_done
L_bc_a5a9884c_use_global:
    ADD S1, GP, R0
    BEQ R0, R0, L_bc_a5a9884c_done
L_bc_a5a9884c_use_stack:
    ADD S1, SB, R0
L_bc_a5a9884c_done:
; LOAD: Using bank register S1 for load
    LOAD S0, S1, S2
