...
; LOAD: Pointer t19 has bank info: Dynamic("gep_new_bank_f0_op44_t19")
    LI T4, -1
    BEQ T7, T4, L_bc_58bdffad_use_global
    LI T1, -2
    BEQ T7, T1, L_bc_58bdffad_use_stack
    ADD T3, T7, R0
    BEQ R0, R0, L_bc_58bdffad_done
L_bc_58bdffad_use_global:
    ADD T3, GP, R0
    BEQ R0, R0, L_bc_58bdffad_done
L_bc_58bdffad_use_stack:
    ADD T3, SB, R0
L_bc_58bdffad_done:
...
; Reload gep_new_bank_f0_op33_t16 from slot 9
    ...
    LOAD T4, SB, SC
    LI T5, -1
    BEQ T4, T5, L_bc_29c846a4_use_global
    LI T0, -2
    BEQ T4, T0, L_bc_29c846a4_use_stack
    ADD T1, T4, R0
    BEQ R0, R0, L_bc_29c846a4_done
L_bc_29c846a4_use_global:
    ADD T1, GP, R0
    BEQ R0, R0, L_bc_29c846a4_done
L_bc_29c846a4_use_stack:
    ADD T1, SB, R0
L_bc_29c846a4_done:
    STORE T2, T1, S0
