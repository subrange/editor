...
; LOAD: Pointer t2 has bank info: Dynamic("load_f0_op8_t2_bank_val")
    LI T3, -1
    BEQ T5, T3, L_bc_b436a636_use_global
    LI T2, -2
    BEQ T5, T2, L_bc_b436a636_use_stack
    ADD T4, T5, R0
    BEQ R0, R0, L_bc_b436a636_done
L_bc_b436a636_use_global:
    ADD T4, GP, R0
    BEQ R0, R0, L_bc_b436a636_done
L_bc_b436a636_use_stack:
    ADD T4, SB, R0
L_bc_b436a636_done:
...
; LOAD: Pointer t4 has bank info: Dynamic("load_f0_op16_t4_bank_val")
    LI T2, -1
    BEQ T6, T2, L_bc_d023fbc6_use_global
    LI T1, -2
    BEQ T6, T1, L_bc_d023fbc6_use_stack
    ADD T3, T6, R0
    BEQ R0, R0, L_bc_d023fbc6_done
L_bc_d023fbc6_use_global:
    ADD T3, GP, R0
    BEQ R0, R0, L_bc_d023fbc6_done
L_bc_d023fbc6_use_stack:
    ADD T3, SB, R0
L_bc_d023fbc6_done:
