...
; LOAD: Pointer t10 has bank info: Dynamic("load_f28_op17_t10_bank_val")
    LI T6, -1
    BEQ T3, T6, L_bc_e21cd67f_use_global
    LI T7, -2
    BEQ T3, T7, L_bc_e21cd67f_use_stack
    ADD T5, T3, R0
    BEQ R0, R0, L_bc_e21cd67f_done
L_bc_e21cd67f_use_global:
    ADD T5, GP, R0
    BEQ R0, R0, L_bc_e21cd67f_done
L_bc_e21cd67f_use_stack:
    ADD T5, SB, R0
L_bc_e21cd67f_done:
...
; Spill t9 to slot 4
    ...
    STORE T1, SB, SC
    LI T1, -1
    BEQ S0, T1, L_bc_e2da3c5d_use_global
; Spill t10 to slot 5
    ADD SC, FP, R0
    ADDI SC, SC, 19
    STORE T4, SB, SC
; Spill load_f28_op17_t10_bank_val to slot 6
    ...
    STORE T3, SB, SC
    LI T4, -2
    BEQ S0, T4, L_bc_e2da3c5d_use_stack
    ADD S1, S0, R0
    BEQ R0, R0, L_bc_e2da3c5d_done
L_bc_e2da3c5d_use_global:
    ADD S1, GP, R0
    BEQ R0, R0, L_bc_e2da3c5d_done
L_bc_e2da3c5d_use_stack:
    ADD S1, SB, R0
L_bc_e2da3c5d_done:
...
; LOAD: Pointer t3 has bank info: Dynamic("gep_new_bank_f34_op9_t3")
    LI T0, -1
    BEQ T2, T0, L_bc_31e86be0_use_global
    LI T6, -2
    BEQ T2, T6, L_bc_31e86be0_use_stack
    ADD T1, T2, R0
    BEQ R0, R0, L_bc_31e86be0_done
L_bc_31e86be0_use_global:
    ADD T1, GP, R0
    BEQ R0, R0, L_bc_31e86be0_done
L_bc_31e86be0_use_stack:
    ADD T1, SB, R0
L_bc_31e86be0_done:
